...
public class RoomController {
    ...
    public ResponseEntity<Room> updateRoom(@PathVariable (value = "id") Long roomId,
                                           @Valid @RequestBody Room roomDetalis ) throws ResourceNotFoundException{

        Room room = roomRepository.findById(roomId)
                .orElseThrow(()-> new ResourceNotFoundException("Room not found this id:: " + roomId));
        room.setName(roomDetalis.getName());
        room.setDate(roomDetalis.getDate());
        room.setStartHour(roomDetalis.getStartHour());
        room.setEndHour(roomDetalis.getEndHour());
